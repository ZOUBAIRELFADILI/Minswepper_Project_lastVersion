...
class AppColor {
  ...
  static Color primaryColor = const Color(0xFFAAD751);
  ...
  static Color backgroundBlue = const Color.fromARGB(255, 236, 246, 255);
  static Color lightGray = const Color.fromARGB(255, 215, 215, 215);
